...
<li><a href="../devops.php">Công nghệ</a></li>
<li><a href="../devops.php">Devops</a></li>
</ol>
<h1>Hướng dẫn cài đặt Jenkins trên Kubernetes cluster </h1>
<div class="post_commentbox"> <a href="#"><i class="fa fa-user"></i>Wpfreeware</a> <span><i class="fa fa-calendar"></i>6:49 AM</span> <a href="../blockchain.php"><i class="fa fa-tags"></i>Công nghệ</a> </div>
<div class="single_page_content"> <img class="img-center" src="../images/image1.png" alt="">
